/*
    This class provides functionality to convert the Celsius temperature into
...
public class CelsiusConverter {
    public static void main(String[] args) {
        ...
        System.out.println("Farenheit Temperatre is: "+CelsiusConverter.convertCelsiusToFarenheit(celsius));
