/*This class provides functionality to convert whole Year into Weeks
 */

public class YearToWeeksCalculator {
    public static void main(String[] args) {
        System.out.println("Weeks in a Year is :"+calculateWeeks());
    }
    private static long calculateWeeks(){
        return Math.round((float) 365 /7);
    }
}
