/*
    This class provides functionality to find the person either Senior Citizen or not
 */
...
public class SeniorCitizenCalculator {
    ...
    public static void main(String[] args) {
        ...
        int ageOfCitizen =scanner.nextInt();


        SeniorCitizenCalculator scc = new SeniorCitizenCalculator();
        scc.calculateAge(ageOfCitizen);
