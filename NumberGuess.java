/*
    This class used to find whether the guessing number is correct or not
...
public class NumberGuess {
    public static void main(String[] args) {
        ...
        guessingNumber(randomNumber,guessNumber);


    }
    private static void guessingNumber(int randomNumber,int guessNumber){
