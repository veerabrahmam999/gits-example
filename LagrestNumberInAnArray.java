/*
    This class provides functionality to find the Largest Number in an Array
 */


public class LagrestNumberInAnArray {
    public static void main(String[] args) {
        int array[]={1,3,4,5,6,2};
        findingLargest(array);
    }
    private static void  findingLargest(int arr[]){
            int temp ;
