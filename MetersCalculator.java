/*This class provides a functionality to convert Kilometers into
      Meters
...
public class MetersCalculator {
    public static void main(String[] args) {
        ...
        System.out.print("Enter the No.of Kilometers: ");
        double kiloMeters=scanner.nextDouble();
        System.out.println(MetersCalculator.kiloMetersToMeters(kiloMeters)+" Meters");
