/*This class provides a functionality to find the intrest amount for loan amount
...
public class IntrestAmountCalculator {
    public static void main(String[] args) {
        ...
        System.out.println("Intrest Amount is: "+IntrestAmountCalculator.calculatingIntrest(loanAmount,roi,timePeriod));

    }
    private static double calculatingIntrest(double loanAmount, double roi, int timePeriod){
