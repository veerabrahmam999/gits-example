...
/*This class provides functionality to calculate the Triangle of Perimeter
 */
...
public class TrianglePerimeter {
    public static void main(String[] args) {
        ...
        System.out.print("Perimeter of Triangle: "+calculatingPerimeter(side1,side2,side3));


    }
    private static double calculatingPerimeter(double side1, double side2, double side3){
