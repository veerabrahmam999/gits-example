/*
    This class provides functionality to finding whether number is even or odd
 */

import java.util.Scanner;

public class EvenOrOddCalculation {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        System.out.print("Enter the number: ");
        int number = scanner.nextInt();
        calculatingEvenOrOdd(number);

    }
    private static void calculatingEvenOrOdd(int number){
        if(number%2==0){
