/*
    This class provides functionality to calculate the area of rectangle
 */
...
public class AreaOfRectangleCalculator {
    public static void main(String[] args) {
        ...
        System.out.println("Area of the Rectangle is :"+AreaOfRectangleCalculator.calculateArea(length,breadth));
    }
