/*This class provides functionality to convert litres into millilitres
...
public class MilliLitresCalculator {
    public static void main(String[] args) {
        ...
        double result = MilliLitresCalculator.calculateMilliLitres(litres);
        System.out.println("Millilitres: "+result);


    }
    private static double calculateMilliLitres(double litres){
