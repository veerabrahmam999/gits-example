...
public class SpeedCalculator {
    public static void main(String[] args) {
        ...
        System.out.println("Speed of the vehicle is "+SpeedCalculator.calculatingSpeed(distance,time)+"(km/hour)");

    }
    private static double calculatingSpeed(double distance,int time){
