...
/*This class provides a functionality to find whether the given character is
      vowel or constant.
 */
...
public class VowelOrConstant {
    public static void main(String[] args) {
        ...
        System.out.println("Result is: "+findingVowelOrConstant(character));


    }
    private static String findingVowelOrConstant(char character){
