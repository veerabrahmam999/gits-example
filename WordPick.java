/*This class provides a functionality to guess the random Words from an Array
 */
...
public class WordPick {
    public static void main(String[] args) {
        ...
        String fruits[]={"apple","banana","guava","mango","lemon"};

        System.out.println("Random Fruit is: "+pickingRandomWord(fruits));
    }
    private static String pickingRandomWord(String fruits[]){
        Random random = new Random();
        String randomFruits = fruits[random.nextInt(fruits.length)];
        return randomFruits;
    }
