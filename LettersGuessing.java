/*This class provides a functionality to guess the random letters
*/
...
public class LettersGuessing {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        Random random = new Random();
        System.out.print("Enter the Guess Letter: ");
        char guessLetter = scanner.next().charAt(0);


        char randomLetter = (char) (random.nextInt(65,122));
        System.out.println("Random Letter is: "+randomLetter);
        System.out.println(guessingLetter(guessLetter,randomLetter));

    }
    private static String guessingLetter(char guessLetter,char randomLetter){
        if(guessLetter==randomLetter){
            return "Guessed correct Character";
            
        }
            

        return "Guessed Wrong Character";
    }
}
