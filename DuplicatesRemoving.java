...
/*
    This class provides functionality to removing the duplicates in a list
 */
...
public class DuplicatesRemoving {
    public static void main(String[] args) {
        ...
        System.out.println(removingDuplicates(list));
    }
    private static Set<Integer> removingDuplicates(List<Integer>list){
        Set<Integer> removingDuplicate=new HashSet<>(list);
