/*This class provides functionality to convert whole week into minutes
 */


public class WeekToMinutesCalculator {
    public static void main(String[] args) {
        System.out.println("Minutes in a week: "+calculateMinutes());

    }
    private static long calculateMinutes(){
        return 7*24*60;
    }
}
