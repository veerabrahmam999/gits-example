/*
    This class provides functionality to reverse the integer
 */
...
public class IntegerReverse {
    public static void main(String[] args) {
        ...
        System.out.println("Reverse Integer is: "+reverseInteger(string));
    }
    private static int reverseInteger(String string){
        String sum="";
        for(int i=string.length()-1;i>=0;i--){
            sum=sum+string.charAt(i);
        }
        int integerReverse=Integer.parseInt(sum);
             return integerReverse;
