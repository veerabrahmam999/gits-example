/*
    This class provides functionality to finding the ascending order elements
 */
...
public class AscendingOrder
{
    public static void main(String[] args) {
            int array[]={3,5,2,1,0};
        System.out.println("Ascending order is: "+Arrays.toString(findingAscendingorder(array)));

    }
    private static int[] findingAscendingorder(int array[]){
        Arrays.sort(array);
        return array;
    }
}
