/*This class provides a functionality to find the year in  which
   he/she  going to touch 100 years
...
public class HundredYearsCalculation {
    public static void main(String[] args) {
        ...
        System.out.println(name+ " you will get Hundred Years in: "+calculationOfAge(age));

    }
    private static int calculationOfAge(int age){
        int difference=100-age;
        int currentYear = LocalDate.now().getYear()+difference;
