...
/*This class provides functionality to find the profit for the person*/
...
public class ProfitCalculator {
    public static void main(String[] args) {
        ...
        double result = ProfitCalculator.calculatingProfit(costPrice, sellingPrice);
        if (result == -1) {
            System.out.print("got loss");
        } else {
            System.out.print(result + "rs profit");
        }


    }

    private static double calculatingProfit(double costPrice, double sellingPrice) {
        double result = -1;
